...
activities = {
    ...
    "Basketball Club": {
        "description": "Pick-up games and skills practice for basketball enthusiasts",
    ...
    "Debate Team": {
        "description": "Practice formal debating, public speaking, and tournament prep",
    ...
    "Robotics Club": {
        ...
        "max_participants": 12,
        "participants": ["samuel@mergington.edu", "jackson@mergington.edu"]
    }
}
